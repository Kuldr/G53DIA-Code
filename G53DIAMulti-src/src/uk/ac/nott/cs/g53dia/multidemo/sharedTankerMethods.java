...
public class sharedTankerMethods {
    ...
    public static boolean checkAtWasteCapacity(int wasteLevel, distanceToEnvRep closestWell, distanceToEnvRep closestFuelPump, int tankerX, int tankerY, int fuelLevel, int size) {
